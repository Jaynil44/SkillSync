...
const CourseDetails = () => {
    ...
    const {avgRating, calculateChapterTime, calculateNoOfLectures, calculateCourseDuration, currency} = useAppContext();
    ...
    const fetchCourseData = () => {
        setCourseData(
            dummyCourses.find((curr_course) =>{
                return curr_course._id === Id;
            })
        )
    };
      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            <p>{avgRating(courseData)}</p>
            <div className='flex'>
              {[...Array(5)].map((_, i) => (<img key={i} src={i < Math.floor(avgRating(courseData)) ? assets.star : assets.star_blank} alt=''
